    ...
    <div>
      ...
      <section className="rush_show">
        <Container>
          ...
          <p>
            Sign up below for Clay & Buck in a Hurry. It's FREE, informative, and fun. Each Friday's email reviews top
            stories, must-see videos and special features.{" "}
          </p>

          <iframe
            loading="lazy"
            src="https://www.e.iheart.com/rushreg/signup-page.html"
            width="100%"
            height="550px"
            frameBorder="0"
            scrolling="no"

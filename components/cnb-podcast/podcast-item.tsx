...
export default function PodcastItem( { podItem, styles } ) {

    const mediaUrl = podItem.enclosure[0].$.url
    return (
        <div className={styles.podcast_item} data-song-index="0" data-media-url={mediaUrl}>
            <div className={styles.song_info}>
                ...
                <div className={styles.top_row}>
                    ...
                    <div className={styles.title_box}>
                        ...
                        <p className={styles.date_time}>{podItem.pubDate[0].slice(0, 17)}</p>
                    </div>
                </div>

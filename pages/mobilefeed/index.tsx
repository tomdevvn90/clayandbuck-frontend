...
const getRssXml = (mobilePosts) => {
  ...
  <rss version="2.0"
      ...
      <channel>
        ...
        <atom:link href="${SITE_URL}/mobilefeed" rel="self" type="application/rss+xml" />
        <link>${SITE_URL}</link>
...
export async function getServerSideProps({ res }) {
  ...
  const mobilePosts = await getMobilePosts(0, 0);
  const mobilePostsFeed = getRssXml(mobilePosts);
